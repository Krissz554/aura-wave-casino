-- =====================================================
-- COMPREHENSIVE ROULETTE STATS & XP FIX
-- =====================================================
-- This ensures all roulette stats and XP tracking works properly

-- =====================================================
-- STEP 1: Create/Replace the update_user_roulette_stats function
-- =====================================================
...
BEGIN
  ...
  RAISE NOTICE 'Roulette stats updated for user %: bet=%, profit=%, win=%, streak=%', 
    p_user_id, p_bet_amount, p_profit, is_win, new_streak;
...
-- =====================================================
-- STEP 2: Create/Replace XP tracking function for wagers
-- =====================================================
...
BEGIN
  ...
  RAISE NOTICE 'XP added for user %: +% XP (total: %), level: % -> %', 
    p_user_id, xp_to_add, new_xp, old_level, new_level;
...
-- =====================================================
-- STEP 3: Create comprehensive roulette bet processor
-- =====================================================
...
BEGIN
  ...
  BEGIN
    ...
    -- Test would go here, but we'll skip actual execution to avoid affecting real data
    RAISE NOTICE '✅ Roulette stats functions created successfully';
...
DO $$
BEGIN
  RAISE NOTICE '🎯 COMPREHENSIVE ROULETTE STATS & XP FIX COMPLETED';
  ...
  RAISE NOTICE '🎰 Roulette stats and XP should now update properly!';
  RAISE NOTICE '';
  RAISE NOTICE '📋 NEXT STEPS:';
  RAISE NOTICE '1. Run this script in Supabase SQL Editor';
  RAISE NOTICE '2. Test placing a roulette bet';
