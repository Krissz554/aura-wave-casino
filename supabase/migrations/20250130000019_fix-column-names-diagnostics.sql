-- Fix column name errors in diagnostics
-- Use correct column names from actual database schema

-- =============================================================================
-- 1. CREATE ALL DIAGNOSTIC FUNCTIONS (CORRECTED)
-- =============================================================================
...
-- =============================================================================
-- 2. RUN ALL DIAGNOSTIC TESTS (WITH CORRECT COLUMN NAMES)
-- =============================================================================
...
-- Test 5: Recent game history (FIXED COLUMN NAMES)
...
SELECT 
  ...
  bet_amount,
  result,
  profit,  -- CORRECTED: was profit_loss, now profit
  created_at,
  game_data
...
-- Test 8: Show recent roulette rounds
SELECT '=== RECENT ROULETTE ROUNDS ===' as test_section;
SELECT 
  id,
  round_number,
  status,
...
-- Test 9: Show recent roulette bets
SELECT '=== RECENT ROULETTE BETS ===' as test_section;
SELECT 
  rb.id,
  rb.user_id,
  rb.bet_color,
...
WHERE rb.user_id = '7ac60cfe-e3f4-4009-81f5-e190ad6de75f'
