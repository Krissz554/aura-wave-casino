-- FIX COLUMN AMBIGUITY IN ULTIMATE INVESTIGATION
...
-- Fixed test function with renamed columns to avoid ambiguity
  ...
  SELECT 
    ...
    EXISTS(
      ...
      WHERE c.table_schema = 'public' 
        AND c.table_name = 'user_level_stats' 
        AND c.column_name = 'lifetime_xp'
    ),
    ''::TEXT;
